let translationMap = {
    ...
    "Ladder Season 2 is live. Play a \"Quick Match\" and get your rank badge now!": "你在搞啥子哦",
    "Having trouble with a command? Type /help to learn more about it.":"不了解聊天指令如何操作？输入/help并回车获取更多关于聊天指令的介绍。",
    "Ladder Season 2 is live. Play a \"Quick Match\" and get your rank badge now! ": "不理解",
    "Join us on Discord: https://discord.gg/uavJ34JTWY": "喵喵喵",
    "您加入了美國指揮中心頻道":"您已返回房间大厅。",
    "您已經與伺服器斷線了":"您已经与服务器断开连接",
    "自訂戰役":"定制对局",
    "基地重新部署":"基地可重新部署",
    "升級工具箱": "随机宝箱",
    "部隊數": "初始作战单位",
    ...
    "自訂競賽": "自定义房间",
    "巨砲": "巨炮",
    "法國的巨砲是究極防守武器，能發射長程破壞力驚人的砲彈。":"法国巨炮拥有惊人破坏力。",
    "傘兵": "空降部队",
    ...
    "Manage and play modified versions of the base game": "游玩其他的Mod版本，基于原生红色警戒",
    ...
    "Grand Cannon": "巨炮",
    "The French Grand Cannon is the ultimate defensive gun, firing at long range for massive damage.": "法国巨炮拥有惊人破坏力。",
    "Tank Destroyer": "坦克杀手",
...
let transDOMMap = {
    "dom-node:discordlink": `<p style="color: red;font-weight: bold;">本站仅用于个人单机游玩</p>`,
    "dom-node:": ``
}
